...
urlpatterns = [
  ...
  path('autores/novo/', views.AutorCreateView.as_view(), name='autor_form'),
  ...
  path('editoras/novo/', views.EditoraCreateView.as_view(), name='editora_form'),
  ...
  path('livros/novo/', views.LivroCreateView.as_view(), name='livro_form'),
